...
const MessageTableToolbar = (props) => {
...
export default function MessagesTable() {
  ...
  return (
    <div className={classes.root}>
      <MessageTableTabs/>
      <MessageTableToolbar numSelected={selected.length} />
